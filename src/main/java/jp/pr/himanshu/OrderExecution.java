...
//Return a new List<jp.pr.himanshu.Order> containing the processed ordering.

public class OrderExecution {

    public List<Order> getRequiredOrders(List<Order> orders) {
//        List<jp.pr.himanshu.Order> requiredOrders = new ArrayList<>();
//
//        List<jp.pr.himanshu.Order> highFilteredOrders = orders.stream().filter(order -> order.priority.equals(jp.pr.himanshu.Priority.HIGH)).toList();
//        List<jp.pr.himanshu.Order> mediumFilteredOrders = orders.stream().filter(order -> order.priority.equals(jp.pr.himanshu.Priority.MEDIUM)).toList();
//        List<jp.pr.himanshu.Order> lowFilteredOrders = orders.stream().filter(order -> order.priority.equals(jp.pr.himanshu.Priority.LOW)).toList();
